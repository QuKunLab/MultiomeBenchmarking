...
## Implementation description
  ...
  the [code/Tutorial.pdf](https://github.com/QuKunLab/MultiomeBenchmarking/blob/main/doc/Tutorial.pdf) is an example showing how to use them to predict protein abundance or chromatin accessibility from gene expression.
