...
feats_name = {"rna": adata_RNA.var_names, "protein": adata_ADT.var_names}

# READ IN THE COUNT MATRICES

# scATAC-seq of batch 1
counts_ADT1 = adata_ADT.X
counts_ADT1 = scmomat.preprocess(counts_ADT1, modality = "protein", log = False)
del adata_ADT
...
counts = {"feats_name": feats_name, "nbatches": 2, "rna":[counts_rna1, counts_rna2], "protein": [counts_ADT1, None]}
