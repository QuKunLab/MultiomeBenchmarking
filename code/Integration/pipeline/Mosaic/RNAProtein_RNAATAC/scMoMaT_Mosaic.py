...
feats_name = {"rna": adata_RNA.var_names, "protein": adata_ADT.var_names, "atac": adata_ATAC.var_names}
...
# Protein of batch 2
counts_ADT2 = adata_ADT.X
counts_ADT2 = scmomat.preprocess(counts_ADT2, modality = "protein", log = False)
del adata_ADT



# CREATE THE COUNTS OBJECT
counts = {"feats_name": feats_name, "nbatches": 2, "rna":[counts_rna1, counts_rna2], "atac": [counts_atac1, None],"protein": [None, counts_ADT2]}

del counts_rna1, counts_rna2, counts_atac1, counts_ADT2
