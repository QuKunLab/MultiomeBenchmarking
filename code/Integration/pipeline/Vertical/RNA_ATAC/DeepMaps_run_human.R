setwd("/home/math/hyl2016/Intergration_Benchmark/testcode_20230710/deepmaps-master")
...
lymph_obj <- ReadData(rna_matrix = rna, atac_matrix = atac,data_type = "scRNA_scATAC", dataFormat = "matrixs", min_cell=0.01, nmad=3, gene.filter=TRUE, cell.filter=FALSE)
...
write.table(HGT_embedding@cell.embeddings, paste0(args[2],'DeepMaps.csv'), sep = ",", row.names = FALSE, col.names = FALSE)
